### Pretty much stolen from [Sims](https://github.com/suchmememanyskill) but I did a tiny change so if you want, donate to them! The links to the original TegraExplorer and where you can donate to Sims are below.
